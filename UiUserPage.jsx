    ...
    <div className="w-full max-w-[1200px] mx-auto pb-20 animate-fade-in">
      ...
      <div className="relative mb-4 md:mb-8 pt-4 md:pt-8">
        ...
        <div className="px-4 md:px-8">
          {/* Changed from Flex to Grid for better mobile control */}
          <div className="grid grid-cols-[auto_1fr] gap-x-4 gap-y-4 md:gap-8 items-start relative z-10">
            
            {/* Avatar - Spans 3 rows on desktop to sit alongside Info, Stats, and Bio */}
            <div className="relative group flex-shrink-0 md:row-span-3">
              <div className="w-24 h-24 md:w-36 md:h-36 rounded-full border-4 border-white dark:border-slate-950 overflow-hidden bg-white dark:bg-slate-900 shadow-lg">
                <img src={PROFILE_DATA.avatar} alt="Profile" className="w-full h-full object-cover" />
              </div>
            ...
            <div className="min-w-0 md:mt-2">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-4">
                <div>
                  ...
                  <p className="text-xs md:text-base text-slate-500 dark:text-slate-400 font-medium">{PROFILE_DATA.handle}</p>
                </div>
            ...
            {/* Stats Row - Spans full width on mobile (col-span-2) */}
            <div className="col-span-2 md:col-span-1 flex items-center gap-6 md:gap-10">
              <div className="flex items-baseline gap-1">
                <span className="font-bold text-slate-900 dark:text-white text-lg">{PROFILE_DATA.posts_count}</span>
                <span className="text-slate-500 text-sm">posts</span>
              </div>
              <div className="flex items-baseline gap-1 cursor-pointer hover:opacity-70">
                <span className="font-bold text-slate-900 dark:text-white text-lg">{PROFILE_DATA.followers}</span>
                <span className="text-slate-500 text-sm">followers</span>
              </div>
              <div className="flex items-baseline gap-1 cursor-pointer hover:opacity-70">
                <span className="font-bold text-slate-900 dark:text-white text-lg">{PROFILE_DATA.following}</span>
                <span className="text-slate-500 text-sm">following</span>
              </div>
            </div>

            {/* Bio & Details - Spans full width on mobile (col-span-2) */}
            <div className="col-span-2 md:col-span-1 max-w-2xl">
              ...
              <div className="flex flex-wrap items-center gap-x-6 gap-y-2 mt-4 text-xs md:text-sm text-slate-500 dark:text-slate-400">
                <div className="flex items-center gap-1.5">
                  <MapPin size={16} /> {PROFILE_DATA.location}
                </div>
                <div className="flex items-center gap-1.5 hover:text-blue-500 cursor-pointer transition-colors">
                  <Link2 size={16} /> {PROFILE_DATA.website}
                </div>
                <div className="flex items-center gap-1.5">
                  <Calendar size={16} /> Joined {PROFILE_DATA.joined}
                </div>
              </div>
            </div>
...
const ContentArea = ({ activeTab, onPushView }) => {
...
const MobileLayout = ({ navStack, activeTab, handleBack, handleNavClick, handlePushView, sharedState }) => {
  ...
  return (
    <div className="flex flex-col h-full w-full md:hidden">
      ...
      {/* 2. Mobile Content */}
      <ContentArea activeTab={activeTab} onPushView={handlePushView} />
